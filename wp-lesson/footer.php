	...
	<div class="bg2 footer-padding">
		<div class="container">
			<div class="footer-wrapper">
				...
				$footer_  = get_field("footer_", "option");

				// Address
				$contact_information = get_field('address', 'option');
				...
				$instagram_link = $social_link['instagram_link'];
				?>
				...
				<div class="footer-logo-description">
					<?php if (!empty($footer_logo_url)) { ?>
						<div class="footer-logo">
							<img src="<?php echo $footer_logo_url[0] ?>" alt="">
						</div>
					<?php }
					if (!empty($footer_)) { ?>
						<!-- Footer Description -->
						<div class="footer-description">
							<p><?php echo $footer_ ?></p>
						<?php } ?>
						</div>
